public class ManavSiparis implements UrunListesiVeSiparis{
    ...
    public void urunListesiVeSiparis() {
        ...
        System.out.println("-----------------------------");
        Manav istenenUrun = Manav.manavList.get(0);
        for (Manav a : Manav.manavList){
        ...
        do {
            System.out.println("How many Kg do you want to buy? press 0 to exit");
        ...
        do {
            System.out.println(istenenUrun.getIsim() + " " + Integer.valueOf(siparisUrun) + " KG "+fiyatAdet+" TL Do you confirm?");
            ...
            switch (onay) {
                case "1":
                    ...
                    if (Login.count>0){
                        ...
                        ayni.isim = istenenUrun.getIsim()+" "+ (Integer.valueOf(kg)+Integer.valueOf(ayni.isim.replaceAll("[^0-9]","")))+" KG";
                        Sepet.sepet.add(ayni);
                        System.out.println("  |  Next --> "+ayni.isim+" "+ayni.fiyat+" TL");
                        urunListesiVeSiparis();
                    }else {
                        System.out.println("Product added to orders...");
                        Sepet urunSepet = new Sepet("Manav",istenenUrun.getIsim() + " " + kg + " KG", fiyatAdet);
